...
HEROKU_DISCLAIMER = (
    '<tg-emoji emoji-id="5366077898480433568">💞</tg-emoji> '
    'Важно: некоторые модули имеют схожий функционал с @heroku_talks, '
    'при этом их структура отличается, так как эти модули были переписаны под этого юзербота. '
    'Мы не выдаём эти модули за свои и всё, что мы сделали - находится в открытом доступе.'
)
...
- Некоторые модули имеют схожий функционал с @heroku_talks, но переписаны под BinaryUserbot; авторство исходных идей не присваивается.
...
FAQ_DATA = {
    ".help": (
        "📋 <b>.help</b>\n\n"
        "Показывает список команд BinaryUserbot, дисклеймер, подсказку по .ub и ссылку на GitHub."
    ),
    ".faq": (
        "❓ <b>.faq</b>\n\n"
...
def get_help_text() -> str:
    alien = pe("alien")
    cmds = [
        ".help", ".faq", ".gpt", ".ub", ".погода", ".цена", ".calc", ".скачать", ".tt",
    ...
    return (
        ...
        f"<blockquote>{HEROKU_DISCLAIMER}</blockquote>\n\n"
