...
_DEFAULTS: dict = {
    ...
    "manager_bot_id":         None,
    "manager_bot_configured_username": None,
    "manager_terminal_history": [],
    "or_token":               None,
    "or_model":               None,
    "ebalaj_system_prompt":   None,
    "troll_system_prompt":    None,
    "antivirus_enabled":      False,
    "last_notified_update":   None,
    "pending_post_restart_notice": None,
}
...
def load(default_logs_id: int, default_bw_chat_id: int = 0) -> None:
    ...
    if not _data.get("bw_chat_id") and default_bw_chat_id:
        _data["bw_chat_id"] = default_bw_chat_id
