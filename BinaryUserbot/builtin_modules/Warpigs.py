...
@client.on(events.NewMessage(pattern=r"^\.autogrow_removed$", outgoing=True))
...
@client.on(events.NewMessage(pattern=r"^\.ungrow_removed$", outgoing=True))
