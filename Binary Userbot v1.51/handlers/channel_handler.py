"""
Авто-комментирование новых постов в каналах.
Список каналов хранится в state.auto_comment_channels (dict {channel_id: discussion_chat_id})
и персистируется через settings.json — редактируется командами .addcom / .delcom / .setting
"""
