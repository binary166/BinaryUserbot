...
Важно: некоторые модули имеют схожий функционал с Heroku, при этом их структура отличается, так как эти модули были переписаны под этого юзербота. Мы не выдаём эти модули за свои и всё, что мы сделали - находится в открытом доступе.
